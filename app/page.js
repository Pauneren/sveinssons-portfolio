...
export default function Home() {
  ...
  return (
    ...
    />
    <span className={`text-white font-bold text-xl ${orbitron.className}`}>Sveinssons</span>
    </div>
    ...
    {['About', 'Services', 'Portfolio', 'Contact'].map((item) => (
      ...
      className="text-white hover:text-primary nav-link"
      style={{
        padding: '0.5rem 1rem',
        borderRadius: '0.5rem',
    ...
    <section className="py-24 px-6">
    <div className="container">
    <h2 className={`text-4xl font-bold mb-16 text-center text-white ${inter.className}`}>What We Do</h2>
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-10" style={{ paddingTop: '3rem' }}>
    <div className="card">
    ...
    <div className="portfolio-grid" style={{ paddingTop: '3rem' }}>
