    ...
    <main className="min-h-screen bg-white text-gray-900 font-inter">
      ...
      <header className="sticky top-0 z-50 bg-purple-900/80 backdrop-blur-md">
        <div className="max-w-6xl mx-auto flex justify-between items-center px-6 py-4">
          ...
          {/* Links */}
          <nav className="space-x-6 text-white font-inter">
            <a href="#contact" className="hover:text-indigo-200 transition">Get in Touch</a>
            <a href="#about" className="hover:text-indigo-200 transition">About Us</a>
            <a href="#services" className="hover:text-indigo-200 transition">What We Do</a>
            <a href="#portfolio" className="hover:text-indigo-200 transition">Portfolio</a>
            <a href="#contact" className="hover:text-indigo-200 transition">Contact Us</a>
          </nav>
        </div>
      </header>
      ...
      <section id="about" className="max-w-4xl mx-auto py-24 px-6">
        <h2 className={`text-4xl font-bold mb-8 text-center ${inter.className}`}>
          About Us
        </h2>
        <p className={`text-lg leading-relaxed text-center text-gray-700 ${inter.className}`}>
          We are <span className="font-semibold">Sveinssons</span> — a creative duo passionate about web development.
          Our goal is to help small businesses and individuals establish a strong online presence with websites
          that are clean, modern, and effective.
        </p>
      </section>

      {/* Services Section */}
      <section id="services" className="bg-gray-50 py-24 px-6">
        <h2 className={`text-4xl font-bold mb-12 text-center ${inter.className}`}>
          What We Do
        </h2>
      ...
      <section id="contact" className="bg-purple-700 text-white py-24 px-6 text-center">
        <h2 className={`text-4xl font-bold mb-8 ${inter.className}`}>
          Let’s Connect
        </h2>
